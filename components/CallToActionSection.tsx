        ...
        <div className="relative z-10 px-6 md:px-8 py-8 md:py-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-start">
            ...
            <div className="grid grid-cols-3 gap-4 md:gap-6 lg:gap-8 text-white mt-6 md:mt-0">
              <div>
                <h3 className="text-sm md:text-lg lg:text-xl font-semibold mb-3 md:mb-4 lg:mb-6 text-white">
                  Find
                </h3>
                <div className="space-y-2 md:space-y-3 lg:space-y-4">
                  <a
                    href="#services"
                    className="block text-gray-300 hover:text-white transition-colors text-xs md:text-sm lg:text-base"
                  >
                    Services
                  </a>
                  <a
