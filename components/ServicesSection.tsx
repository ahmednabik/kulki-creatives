  ...
  const services = [
    {
      ...
      image:
        "https://framerusercontent.com/images/W8leNG1ES23NMXQy1Ur1MAwhwo.png?scale-down-to=512",
      bgColor: "bg-blue-100",
    },
    {
      title: "Labels",
      ...
      image:
        "https://framerusercontent.com/images/xCP9g69JkBzblynEWvhsUXw9HVU.png?scale-down-to=512",
    ...
    },
    {
      ...
      image:
        "https://framerusercontent.com/images/mqeIukL7mTLJpQJhvVKBmPNs95M.png?scale-down-to=512",
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          {services.map((service, index) => {
            ...
            return (
              <div
                key={index}
                className={`${service.bgColor} p-8 rounded-3xl transition-transform hover:rotate-0 ${rotationClass}`}
              >
                <div className="mb-6">
                  <Image
                    src={service.image}
